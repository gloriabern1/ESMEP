<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ESMEP_EdoStateMinistryOfEducationPortal_.Account.OpenAuthProviders" %>
